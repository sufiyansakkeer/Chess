...
class SwitchableChessPiece extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ThemeBloc, ThemeState>(
      buildWhen:
          (previous, current) =>
              previous.useRedesignedPieces != current.useRedesignedPieces,
      builder: (context, themeState) {
        // Get the redesigned pieces setting from the ThemeBloc
        final useRedesignedPieces = themeState.useRedesignedPieces;
          ...
          child: AnimatedScale(
            ...
            child: AnimatedRotation(
              ...
              child: SvgPicture.asset(
                _getPieceAsset(useRedesignedPieces),
                height: 32,
                width: 32,
                colorFilter:
                    _shouldApplyColorFilter(useRedesignedPieces)
  ...
  bool _shouldApplyColorFilter(bool useRedesignedPieces) {
